regex =
  ...
  rel_time:        ///(half-day|
                      ...
                      midnight|
                      ([0-9]+(?:\.+[0-9]*)?) hours)///i
  time:            ///((\b([0-1][0-9])|(2[0-3])):([0-5][0-9])\b)|
                    (\b(0?[1-9])|(1[0-2]))(?:(:[0-5][0-9] ?(am?|pm?)?)|
                    (am?|pm?)\b)///i
  months:          ///\b(?:Jan(?:uary)?|
                            Mar(?:ch)?|
                            May|
  ...
  date:            ///(\b(?:Jan(?:uary)?|
                            ...
                            Aug(?:ust)?|
                            Oct(?:ober)?|
                            Dec(?:ember)?) (?:3[01]|[0-2]*[0-9])
                            (?: ?- ?(3[01]|[0-2]*[0-9]))?\b)|
                            (\b(?:Sep(?:tember)?|
                            Apr(?:il)?|
                            Jun(?:e)?|
                            Nov(?:ember)?) (?:30|[0-2]*[0-9])
                            (?: ?- ?(30|[0-2]*[0-9]))?\b)|
                            (\b(?:Feb(?:ruary)?) (?:29|[0-2]*[0-8])
                            (?: ?- ?(29|[0-2]*[0-8]))?\b)///i
  numdate:         ///((?:\b(0?2)\/(0?[1-9]|[1-2][0-9])\b)|
                        (?:\b(0?[469]|11)\/(0?[1-9]|[1-2][1-9]|30)\b)|
                        (?:\b(0?[13578]|
                        (10|12))\/(0?[1-9]|[1-2][1-9]|3[01])\b))
                        (?: ?- ?((?:\b(0?2)\/(0?[1-9]|[1-2][0-9])\b)|
                        (?:\b(0?[469]|11)\/(0?[1-9]|[1-2][1-9]|30)\b)|
                        (?:\b(0?[13578]|(10|12))\/
                        (0?[1-9]|[1-2][1-9]|3[01])\b)))?///i
